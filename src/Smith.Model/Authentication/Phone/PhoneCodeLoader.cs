...
namespace Smith.Model.Authentication.Phone
{
    public class PhoneCodeLoader
    {
        ...
        {
            var uri = new Uri($"resm:Smith.Application.Images.Flags.{countryCode}.png?assembly=Smith.Application");
            if (!assetLoader.Exists(uri))
            {
                uri = new Uri($"resm:Smith.Application.Images.Flags._unknown.png?assembly=Smith.Application");
            }
